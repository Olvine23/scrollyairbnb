    ...
    return (
        <Layout additionalClass={['bg-light-gray']}>
            ...
            <div className="flex flex-wrap max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <RecipeBackButton additionalClass={['mt-12 mb-5 text-[#e0c45c] uppercase']} backButtonText="Go back" />
            </div>
            <div className="flex flex-wrap max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div
                ...
                <div className="flex flex-col basis-full lg:basis-1/2 pl-0 lg:pl-12 pt-5 pb-10 bg-white">
                    <div className="flex flex-wrap justify-start text-sm font-light space-x-5 py-5">
                        <p className="px-4 py-3 bg-[#ac3f21] rounded-full text-white">
                            Time:
                            {' '}
                    ...
                    <Header additionalClasses={['text-xl md:text-5xl text-black text-secondary !font-normal']}>
                        {recipe.name}
                    </Header>
                    <Paragraph>
                        {recipe.description}
            ...
            <div className="flex flex-wrap max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <RecipeSteps steps={recipe.steps} additionalClass={['my-5']} headerText="" />
            </div>
            <HeaderImageWithText
                recipe={recipe}
                headerText1="Enjoy"
                ...
                headerText3="stay!"
            />
            <RecipeCards recipes={recipes} headerText="Explore other locations:" />
        </Layout>
    );
};
