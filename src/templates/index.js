    ...
    return (
        <Layout additionalClass={['bg-light-gray']}>
            ...
            <Announcement
                content={
                    <span className="text-3xl  ">
                        We connect you to memorable experiences,
                        specially curated to attend to your personal, family or
                        corporate needs
                    </span>
                }
                rounded="none"
            ...
            <RecipeFeaturedCard
                ...
                slug={recipes[0].slug}
            />
            <RecipeCards recipes={recipes} headerText="Newest Locations" />
            <Pagination
                ...
                prevNextAdditionalClasses={[
                    '!bg-primary px-3 md:px-4 !w-auto !text-white',
                ]}
                activeAdditionalClasses={[
                    '!font-semibold before:block before:absolute ' +
